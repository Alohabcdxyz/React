...
class ManageExtraProfile extends Component {
  constructor(props) {
    super(props);
    this.state = {
      genderArr: [],
  ...
  componentDidUpdate(prevProps, prevState, snapshot) {
    ...
    if (prevProps.listUsers !== this.props.listUsers) {
      ...
      const userData = this.props.listUsers.find(
        (user) => user.id === userInfor.id
      );
  ...
  // Add this function inside your ManageExtraProfile class
    ...
    return (
      <>
        <div className='redux-container'>
          <div className='title'>Quản lý hồ sơ</div>
          <div>
